    ...
    return (
        <div className="flex justify-center items-center w-full h-full px-6 bg-gray-100">
            <form onSubmit={handleSubmit} className="rounded-xl bg-white px-4 pt-12 pb-4 min-w-[20rem] max-w-[24rem]">
                <div className="text-center mb-6"> <span className="px-4 py-2 rounded-xl bg-blue-600 text-white font-semibold">BotSub Admin</span></div>
                ...
                <div className="text-right mt-10"> <button ref={button} type="submit" className="text-blue-600 bg-blue-100 px-8 py-2 rounded-full"> login </button> </div>
            </form>
        </div>
    )
}